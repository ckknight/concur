...
(function (root) {
    ...
    /**
     * Throw an error after waiting a tick, essentially throwing an error asynchronously.
     *
     * This is handy for if a function must be guaranteed to return a value, but its error should be propagated to the top of the stack.
     *
     * @api public
     *
     * @param {Object} an error to throw. Anything but null or undefined is acceptable.
     * @example
     ...
     * }
     */
    concur["throw"] = concur.raise = function (err) {
        if (err == null) {
            throw new TypeError("err must be not be null or undefined");
        }
