/*global setTimeout: false, module: false, process: false */
...
(function (root) {
    ...
    /**
     * the hashCode generator if one is not provided to concur.memoize
     *
     * @api private
     *
     ...
     */
    var standardGetHashCode = function (x) {
        return "" + x;
    };
     ...
     * })
     */
    concur.memoize = function (func, index, getHashCode) {
        if (!getHashCode) {
            getHashCode = standardGetHashCode;
        }
        ...
        return function () {
            ...
            if (typeof callback !== "function") {
                throw TypeError("Expected argument #" + index + " to be a function");
            }
            var hashCode = getHashCode.apply(this, args);
            if (has.call(cache, hashCode)) {
                callback.apply(this, cache[hashCode]);
            } else {
                args.splice(index, 0, function () {
                    if (!has.call(cache, hashCode)) {
                        cache[hashCode] = slice.call(arguments);
                    }
                    callback.apply(this, cache[hashCode]);
                });
    ...
    concur.throttle = function (delayInMilliseconds, omitLast, callback) {
        delayInMilliseconds >>>= 0; // coerce to UInt32
